  ...
  updateDataLayer(data) {
    ...
    const geoJsonLayer = L.geoJSON(data, {
      ...
      style: function (feature) {
        // Customize the style of GeoJSON polygons here
        return {
          fillColor: '#FFBB33', // Change this to your desired fill color
          fillOpacity: 0.5,
          color: '#FFAA00',
          weight: 4
        };
      }
    }).bindTooltip((l) => l.feature.properties.label).addTo(this.dataLayer);
